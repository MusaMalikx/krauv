...
const InactiveItem = ({ title }) => {
  return (
    <div className="bg-[#E5E5E5] dark:bg-black h-[calc(100vh-159.49px)] flex justify-center items-center overflow-y-scroll ">
      <div className="">
        <div className="flex flex-col items-center justify-center space-y-12 bg-[#fff] dark:bg-[#18181A] p-12 rounded shadow max-w-7xl">
          <div>
